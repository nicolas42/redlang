...
total: sum: func [b] [	t: 0 foreach i reduce span b [t: t + i]]
avg: func [b] [	divide sum b length? span b]
...
sheet: [
	...
	style label text cell-size black silver center
	style menu2 text 60x20 black bold edge none with [
		font/colors: [0.0.0 0.0.255]
	]
	style menu text 100x50 [] blue underline center 
		font [size: 20 colors: reduce [blue col]]  
		para [origin: 0x10]
	...
	;menu "Color" [col: choose-color]
	;menu "Font" [show-fonts]
	menu "New"  #"^n" [new-sheet]  
	menu "Open" #"^o" [open-sheet]
	menu "Save" #"^s" [save-sheet] 
	menu "Save As" #"^a" [save-sheet/as]
...
view/options center-face lay [resize]
