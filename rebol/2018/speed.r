REBOL [
	...
	Note: {
		If the console width is less than 72 characters the autobackspacing of the console writes test won't work which means it will print out a page of dots instead of a line of them.
		Nicolas Schmidt 8-6-2013
	}
]
