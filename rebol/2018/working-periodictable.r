...
foreach [el sym name pos series state weight orbits] elements [
    ...
    append pte reduce [
        'at as-pair add either greater? pos/y 8 [7][0] multiply pos/x 40 multiply pos/y 40
        'button 39x39 to-string sym series 'font compose [color: (state) name: "fixedsys" style: none] compose/deep [set-face clicked (blurb)  img/effect: [(spins orbits)]  show img]
    ]
]
