...
//2-9-2012 removed almost all math.Sqrt references
...
func main() {
	...
	projectEuler20()
	projectEuler21()
	println("22 needs to call rebol ")
	projectEuler23()
	projectEuler24()	
	println("time taken", time.Now().Sub(t1) / 1000000, "milliseconds")
}
...
;Rebol program (200kb interpreter) at
;http://www.rebol.com/downloads/v278/rebol-core-278-4-3.tar.gz

;n names, s score, c char, t total

n: read http://projecteuler.net/project/names.txt
...
//What is the greatest product of four adjacent numbers in any direction (up, down, left, right, or diagonally) in the 2020 grid? Grid at http://projecteuler.net/problem=11
