...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_average: "f_average" [] 
            f_last?: "f_last?" [] 
            f_ctx||212~platform: "f_ctx||212~platform" [octx [pointer! [integer!]]] 
            f_ctx||241~interpreted?: "f_ctx||241~interpreted?" [octx [pointer! [integer!]]] 
            f_ctx||250~on-change*: "f_ctx||250~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||248~on-change*: "f_ctx||248~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||248~on-deep-change*: "f_ctx||248~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||271~throw-error: "f_ctx||271~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||271~make-time: "f_ctx||271~make-time" [octx [pointer! [integer!]]] 
            f_ctx||271~to-word: "f_ctx||271~to-word" [octx [pointer! [integer!]]] 
            f_ctx||271~pop: "f_ctx||271~pop" [octx [pointer! [integer!]]] 
            f_ctx||271~store: "f_ctx||271~store" [octx [pointer! [integer!]]] 
            f_ctx||271~transcode: "f_ctx||271~transcode" [octx [pointer! [integer!]]] 
            f_ctx||271~init: "f_ctx||271~init" [octx [pointer! [integer!]]] 
            f_ctx||298~encode: "f_ctx||298~encode" [octx [pointer! [integer!]]] 
            f_ctx||298~decode: "f_ctx||298~decode" [octx [pointer! [integer!]]] 
            f_ctx||307~to-csv-line: "f_ctx||307~to-csv-line" [octx [pointer! [integer!]]] 
            f_ctx||307~escape-value: "f_ctx||307~escape-value" [octx [pointer! [integer!]]] 
            f_ctx||307~next-column-name: "f_ctx||307~next-column-name" [octx [pointer! [integer!]]] 
            f_ctx||307~make-header: "f_ctx||307~make-header" [octx [pointer! [integer!]]] 
            f_ctx||307~get-columns: "f_ctx||307~get-columns" [octx [pointer! [integer!]]] 
            f_ctx||307~encode-map: "f_ctx||307~encode-map" [octx [pointer! [integer!]]] 
            f_ctx||307~encode-maps: "f_ctx||307~encode-maps" [octx [pointer! [integer!]]] 
            f_ctx||307~encode-flat: "f_ctx||307~encode-flat" [octx [pointer! [integer!]]] 
            f_ctx||307~encode-blocks: "f_ctx||307~encode-blocks" [octx [pointer! [integer!]]] 
            f_load-csv: "f_load-csv" [octx [pointer! [integer!]]] 
            f_to-csv: "f_to-csv" [octx [pointer! [integer!]]] 
            f_ctx||320~on-change*: "f_ctx||320~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||323~on-change*: "f_ctx||323~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||323~on-deep-change*: "f_ctx||323~on-deep-change*" [octx [pointer! [integer!]]] 
            f_reactor: "f_reactor" [] 
            f_deep-reactor: "f_deep-reactor" [] 
            f_ctx||328~add-relation: "f_ctx||328~add-relation" [octx [pointer! [integer!]]] 
            f_ctx||328~eval: "f_ctx||328~eval" [octx [pointer! [integer!]]] 
            f_ctx||328~eval-reaction: "f_ctx||328~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx||328~pending?: "f_ctx||328~pending?" [octx [pointer! [integer!]]] 
            f_ctx||328~check: "f_ctx||328~check" [octx [pointer! [integer!]]] 
            ...
            f_ctx||328~is~: "f_ctx||328~is~" [octx [pointer! [integer!]]] 
            f_react?: "f_react?" [octx [pointer! [integer!]]] 
            f_react: "f_react" [octx [pointer! [integer!]]] 
            f_register-scheme: "f_register-scheme" [] 
            f_ctx||343~alpha-num+: "f_ctx||343~alpha-num+" [octx [pointer! [integer!]]] 
            f_ctx||343~parse-url: "f_ctx||343~parse-url" [octx [pointer! [integer!]]] 
            f_decode-url: "f_decode-url" [octx [pointer! [integer!]]] 
            f_encode-url: "f_encode-url" [octx [pointer! [integer!]]] 
            f_ctx||349~do-quit: "f_ctx||349~do-quit" [octx [pointer! [integer!]]] 
            f_ctx||349~throw-error: "f_ctx||349~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||349~syntax-error: "f_ctx||349~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx||349~do-safe: "f_ctx||349~do-safe" [octx [pointer! [integer!]]] 
            f_ctx||349~do-code: "f_ctx||349~do-code" [octx [pointer! [integer!]]] 
            f_ctx||349~count-args: "f_ctx||349~count-args" [octx [pointer! [integer!]]] 
            f_ctx||349~arg-mode?: "f_ctx||349~arg-mode?" [octx [pointer! [integer!]]] 
            f_ctx||349~func-arity?: "f_ctx||349~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx||349~value-path?: "f_ctx||349~value-path?" [octx [pointer! [integer!]]] 
            f_ctx||349~fetch-next: "f_ctx||349~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx||349~eval: "f_ctx||349~eval" [octx [pointer! [integer!]]] 
            f_ctx||349~do-macro: "f_ctx||349~do-macro" [octx [pointer! [integer!]]] 
            f_ctx||349~register-macro: "f_ctx||349~register-macro" [octx [pointer! [integer!]]] 
            f_ctx||349~reset: "f_ctx||349~reset" [octx [pointer! [integer!]]] 
            f_ctx||349~expand: "f_ctx||349~expand" [octx [pointer! [integer!]]] 
            ...
            f_ctx||384~tail-idx?: "f_ctx||384~tail-idx?" [octx [pointer! [integer!]]] 
            f_ctx||384~push-color: "f_ctx||384~push-color" [octx [pointer! [integer!]]] 
            f_ctx||384~pop-color: "f_ctx||384~pop-color" [octx [pointer! [integer!]]] 
            f_ctx||384~close-colors: "f_ctx||384~close-colors" [octx [pointer! [integer!]]] 
            f_ctx||384~push: "f_ctx||384~push" [octx [pointer! [integer!]]] 
            f_ctx||384~pop: "f_ctx||384~pop" [octx [pointer! [integer!]]] 
            f_ctx||384~pop-all: "f_ctx||384~pop-all" [octx [pointer! [integer!]]] 
            f_ctx||384~optimize: "f_ctx||384~optimize" [octx [pointer! [integer!]]] 
            f_rtd-layout: "f_rtd-layout" [octx [pointer! [integer!]]] 
            f_ctx||382~line-height?: "f_ctx||382~line-height?" [octx [pointer! [integer!]]] 
            f_ctx||382~line-count?: "f_ctx||382~line-count?" [octx [pointer! [integer!]]] 
            f_metrics?: "f_metrics?" [] 
            ...
            f_ctx||404~on-change*: "f_ctx||404~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||404~on-deep-change*: "f_ctx||404~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||408~on-change*: "f_ctx||408~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||408~on-deep-change*: "f_ctx||408~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||412~on-change*: "f_ctx||412~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||415~on-change*: "f_ctx||415~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||418~capture-events: "f_ctx||418~capture-events" [octx [pointer! [integer!]]] 
            f_ctx||418~awake: "f_ctx||418~awake" [octx [pointer! [integer!]]] 
            f_ctx||427~init: "f_ctx||427~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            f_ctx||437~color-backgrounds: "f_ctx||437~color-backgrounds" [octx [pointer! [integer!]]] 
            f_ctx||437~color-tabpanel-children: "f_ctx||437~color-tabpanel-children" [octx [pointer! [integer!]]] 
            f_ctx||437~OK-Cancel: "f_ctx||437~OK-Cancel" [octx [pointer! [integer!]]] 
            f_ctx||435~process: "f_ctx||435~process" [octx [pointer! [integer!]]] 
            f_ctx||433~throw-error: "f_ctx||433~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||433~process-reactors: "f_ctx||433~process-reactors" [octx [pointer! [integer!]]] 
            f_ctx||433~calc-size: "f_ctx||433~calc-size" [octx [pointer! [integer!]]] 
            f_ctx||433~align-faces: "f_ctx||433~align-faces" [octx [pointer! [integer!]]] 
            f_ctx||433~resize-child-panels: "f_ctx||433~resize-child-panels" [octx [pointer! [integer!]]] 
            f_ctx||433~clean-style: "f_ctx||433~clean-style" [octx [pointer! [integer!]]] 
            f_ctx||433~process-draw: "f_ctx||433~process-draw" [octx [pointer! [integer!]]] 
            f_ctx||433~pre-load: "f_ctx||433~pre-load" [octx [pointer! [integer!]]] 
            f_ctx||433~add-option: "f_ctx||433~add-option" [octx [pointer! [integer!]]] 
            f_ctx||433~add-flag: "f_ctx||433~add-flag" [octx [pointer! [integer!]]] 
            f_ctx||433~fetch-value: "f_ctx||433~fetch-value" [octx [pointer! [integer!]]] 
            f_ctx||433~fetch-argument: "f_ctx||433~fetch-argument" [octx [pointer! [integer!]]] 
            f_ctx||433~fetch-expr: "f_ctx||433~fetch-expr" [octx [pointer! [integer!]]] 
            f_ctx||433~fetch-options: "f_ctx||433~fetch-options" [octx [pointer! [integer!]]] 
            f_ctx||433~make-actor: "f_ctx||433~make-actor" [octx [pointer! [integer!]]] 
            ...
            ctx||271~make-hm: "ctx||271~make-hm" [h [integer!] m [integer!]] 
            ctx||271~make-msf: "ctx||271~make-msf" [m [integer!] s [float!]] 
            ctx||271~make-hms: "ctx||271~make-hms" [h [integer!] m [integer!] s [integer!]] 
            ctx||271~make-hmsf: "ctx||271~make-hmsf" [h [integer!] m [integer!] s [float!]] 
            ctx||271~make-binary: "ctx||271~make-binary" [start [red-string!] end [red-string!] base [integer!]] 
            ctx||271~make-tuple: "ctx||271~make-tuple" [start [red-string!] end [red-string!]] 
            ctx||271~make-number: "ctx||271~make-number" [start [red-string!] end [red-string!] type [red-datatype!]] 
            ctx||271~make-float: "ctx||271~make-float" [start [red-string!] end [red-string!] type [red-datatype!]] 
            ctx||271~make-hexa: "ctx||271~make-hexa" [start [red-string!] end [red-string!] return: [integer!]] 
            ctx||271~make-char: "ctx||271~make-char" [start [red-string!] end [red-string!]] 
            ctx||271~push-path: "ctx||271~push-path" [stack [red-block!] type [red-datatype!]] 
            ctx||271~set-path: "ctx||271~set-path" [stack [red-block!]] 
            ctx||271~make-word: "ctx||271~make-word" [src [red-string!] end [red-string!] type [red-datatype!]] 
            ctx||271~new-line: "ctx||271~new-line" [series [cell!]] 
            ctx||282~encode: "ctx||282~encode" [img [red-image!] where [cell!]] 
            ctx||282~decode: "ctx||282~decode" [data [cell!]] 
            ctx||286~encode: "ctx||286~encode" [img [red-image!] where [cell!]] 
            ctx||286~decode: "ctx||286~decode" [data [cell!]] 
            ctx||290~encode: "ctx||290~encode" [img [red-image!] where [cell!]] 
            ctx||290~decode: "ctx||290~decode" [data [cell!]] 
            ...
            ctx||427~make-null-handle: "ctx||427~make-null-handle" [] 
            ctx||427~get-screen-size: "ctx||427~get-screen-size" [id [integer!]] 
            ctx||427~size-text: "ctx||427~size-text" [face [red-object!] value [cell!]] 
            ctx||427~on-change-facet: "ctx||427~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx||427~update-font: "ctx||427~update-font" [font [red-object!] flags [integer!]] 
            ctx||427~update-para: "ctx||427~update-para" [face [red-object!] flags [integer!]] 
            ctx||427~destroy-view: "ctx||427~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx||427~update-view: "ctx||427~update-view" [face [red-object!]] 
            ctx||427~refresh-window: "ctx||427~refresh-window" [h [red-handle!]] 
            ctx||427~redraw: "ctx||427~redraw" [face [red-object!]] 
            ctx||427~show-window: "ctx||427~show-window" [id [red-handle!]] 
            ctx||427~make-view: "ctx||427~make-view" [face [red-object!] parent [red-handle!]] 
            ctx||427~draw-image: "ctx||427~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx||427~draw-face: "ctx||427~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx||427~do-event-loop: "ctx||427~do-event-loop" [no-wait? [logic!]] 
            ctx||427~exit-event-loop: "ctx||427~exit-event-loop" [] 
            ctx||427~request-font: "ctx||427~request-font" [font [red-object!] selected [red-object!] mono? [logic!]] 
            ctx||427~request-file: "ctx||427~request-file" [title [red-string!] name [red-file!] filter [red-block!] save? [logic!] multi? [logic!]] 
            ctx||427~request-dir: "ctx||427~request-dir" [title [red-string!] dir [red-file!] filter [red-block!] keep? [logic!] multi? [logic!]] 
            ctx||427~text-box-metrics: "ctx||427~text-box-metrics" [box [red-object!] arg0 [cell!] type [integer!]] 
            ctx||427~update-scroller: "ctx||427~update-scroller" [scroller [red-object!] flags [integer!]] 
            ...
            parse-text-styles: "parse-text-styles" [dc [pointer! [integer!]] layout [pointer! [integer!]] cmds [red-block!] max-len [integer!] catch? [logic!]] 
